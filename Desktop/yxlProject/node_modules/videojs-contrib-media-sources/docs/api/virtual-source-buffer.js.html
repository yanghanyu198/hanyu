...
export default class VirtualSourceBuffer extends videojs.EventTarget {
  ...
  done_(event) {
    ...
    console.log('SOURCE BUFFER -> transmuxing done_');
  ...
  appendBuffer(segment) {
    ...
    console.log('SOURCE BUFFER -> appendBuffer');
    ...
    [segment.buffer]);
    console.log('SOURCE BUFFER -> appendBuffer -> sent to transmuxer');
  ...
  processPendingSegments_() {
    ...
    if (this.videoBuffer_) {
      ...
      console.log('SOURCE BUFFER -> concatAndAppendSegments_ -> data sent to native buffer');
    ...
    this.bufferUpdating_ = false;
    console.log('SOURCE BUFFER -> done processing, updating state set to false');
  }
